...
summary(model1)
plot(model1)
#Model looks fine. But there are some leverage points.
#Key, loudness, mode, instrumentalness, liveness, tempo have high p-values.
...
hat3<-hatvalues(model4)
print(2*(5+1)/100)
high3<-which(hat3>0.12)
print(high3)
r3<-rstandard(model4)
bad3<-which(abs(r3)>2)
print(bad3)
